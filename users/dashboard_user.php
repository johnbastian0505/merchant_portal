...
<?php
	...
	$sql2  = mysqli_query($con, "SELECT * FROM merchant_portal_orders WHERE Merchant_Merchant_slug = '".$Merchant_Slug."' AND Status = 'PENDING' ORDER BY id DESC ");
	?>
<section id="section_orders">
	<div class="container-fluid">
		<div class="row">
			<div class="col-lg-6 Merchant_Name">
				<h1>Welcome to <?php echo $Merchant_Name; ?> Portal</h1>
			</div>
...
<section class="Approved_orders_dashboard">
	<?php 
	$sql2  = mysqli_query($con, "SELECT * FROM merchant_portal_orders WHERE Merchant_Merchant_slug = '".$Merchant_Slug."' AND Status = 'APPROVED' ORDER BY id ASC");
